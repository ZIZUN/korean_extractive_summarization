...
if __name__ == '__main__':
    ...
    # python main.py -task train -target_summary_sent abs -visible_gpus 0 -train_from 1209_1236/model_step_7000.pt 
        ...
        do_str = f"python train.py -task ext -mode train"  \
            ...
            + f" -save_checkpoint_steps 500 -visible_gpus {args.visible_gpus} -report_every 100"
        ...
        param3 = " -ext_dropout 0.1 -max_pos 512 -lr 8e-4 -warmup_steps 5000 -batch_size 300 -accum_count 1 -train_steps 50000  -use_interval true -seed 705"
        do_str += param3
